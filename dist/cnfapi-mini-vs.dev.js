(function (global, factory) {
	...
	var defineProperty$2$1 = _objectDp$1.f;
	var _wksDefine$1 = function (name) {
	  var $Symbol = _core$1.Symbol || (_core$1.Symbol =  {} );
	  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$2$1($Symbol, name, { value: _wksExt$1.f(name) });
	};

	var f$2$1 = Object.getOwnPropertySymbols;

	var _objectGops$1 = {
		f: f$2$1
	};

	var f$3$1 = {}.propertyIsEnumerable;
	...
	var f$6$1 = _descriptors$1 ? gOPD$2 : function getOwnPropertyDescriptor(O, P) {
	  O = _toIobject$1(O);
	  P = _toPrimitive$1(P, true);
	  if (_ie8DomDefine$1) try {
	    return gOPD$2(O, P);
	...
	// 24.3.2 JSON.stringify(value [, replacer [, space]])
	$JSON$1$1 && _export$1(_export$1.S + _export$1.F * (!USE_NATIVE$1 || _fails$1(function () {
	  var S = $Symbol$1();
	  // MS Edge converts symbol values to JSON as {}
	  // WebKit converts symbol values to JSON as null
	  // V8 throws on boxed symbols
	...
	var defineProperty$3$1 = (function() {
	  try {
	...
	var _defineProperty$1 = defineProperty$3$1;
	...
	var defineProperties$2 = function defineProperties(T, D) {
	...
	var _ownKeys$1 = Reflect$2 && Reflect$2.ownKeys || function ownKeys(it) {
	...
	var getOwnPropertyDescriptors$1$1 = getOwnPropertyDescriptors$2;

	// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)

	var $getOwnPropertyDescriptor$1$1 = _objectGopd$1.f;

	_objectSap$1('getOwnPropertyDescriptor', function () {
	  return function getOwnPropertyDescriptor(it, key) {
	    return $getOwnPropertyDescriptor$1$1(_toIobject$1(it), key);
	  };
	});

	var $Object$3$1 = _core$1.Object;
	var getOwnPropertyDescriptor$2 = function getOwnPropertyDescriptor(it, key) {
	  return $Object$3$1.getOwnPropertyDescriptor(it, key);
	};

	var getOwnPropertyDescriptor$1$1 = getOwnPropertyDescriptor$2;

	var getOwnPropertySymbols$2 = _core$1.Object.getOwnPropertySymbols;

	var getOwnPropertySymbols$1$1 = getOwnPropertySymbols$2;
	...
	var defineProperty$4$1 = _defineProperty$1$1;
	...
	// statics
	_export$1(_export$1.S + _export$1.F * !USE_NATIVE$1$1, PROMISE, {
	...
	function ownKeys$1(object,enumerableOnly){var keys=keys$1(object);if(getOwnPropertySymbols$1){var symbols=getOwnPropertySymbols$1(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return getOwnPropertyDescriptor$1(object,sym).enumerable})),keys.push.apply(keys,symbols);}return keys}function _objectSpread$1(target){for(var source,i=1;i<arguments.length;i++)source=null==arguments[i]?{}:arguments[i],i%2?ownKeys$1(source,!0).forEach(function(key){defineProperty$3(target,key,source[key]);}):getOwnPropertyDescriptors$1?defineProperties$1(target,getOwnPropertyDescriptors$1(source)):ownKeys$1(source).forEach(function(key){defineProperty$1(target,key,getOwnPropertyDescriptor$1(source,key));});return target}function vsApi(){var _ref=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{apiList:{}},_ref$baseURL=_ref.baseURL,baseURL=void 0===_ref$baseURL?"":_ref$baseURL,_ref$env=_ref.env,env=void 0===_ref$env?"weapp":_ref$env,_ref$appKey=_ref.appKey,appKey=void 0===_ref$appKey?"":_ref$appKey,_ref$appSecret=_ref.appSecret,appSecret=void 0===_ref$appSecret?"":_ref$appSecret,apiList=_ref.apiList,_resInterceptor=_ref.resInterceptor,_openResInterceptor=_ref.openResInterceptor,_resSuccessCallback=_ref.resSuccessCallback,_ref$headers=_ref.headers,headers=void 0===_ref$headers?{"Content-Type":"application/json"}:_ref$headers,api=new Api({baseURL:baseURL,env:env,timeout:1e4,headers:headers,resSuccessCallback:function resSuccessCallback(data,next){return _resSuccessCallback&&"function"==typeof _resSuccessCallback?_resSuccessCallback(data,next):void(200===data.retcode?next(null,data.data,data.retcode):next({msg:data.msg,retcode:data.retcode},{},data.retcode))},openResInterceptor:function openResInterceptor(res){return "function"==typeof _openResInterceptor&&_openResInterceptor.call(this,res)},resInterceptor:function resInterceptor(serverData,next){return "function"==typeof _resInterceptor?_resInterceptor.bind(this)(serverData,next):next()}},apiList);return api._before=function(apiOpts,apiConf,next){var signKeys=apiConf.signKeys,signData={},data=apiOpts.data;data||(data={}),data.app_key=appKey,keys$1(data).forEach(function(item){-1<signKeys.indexOf(item)&&(signData[item]=data[item]);}),data.sign=defaultSign(signData,[appSecret]),next(_objectSpread$1({},apiOpts,{data:data}));},api}
